function params = params_histresponse_auV1(params) 
...
params.conv_sigma           = 0.050e6;           %sd of gaussian window for smoothing
...
params.twin_baseline_start  = -0.5e6;         %Start window for calculating baseline
params.twin_baseline_stop   = -0.1e6;       %End window baseline
params.twin_resp_start      = 0e6;          %Start window for calculating response
params.twin_resp_stop       = 0.2e6;          %End window response
