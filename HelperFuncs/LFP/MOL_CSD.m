function [meancsd,meanresp] = MOL_CSD(params, events_ts, lfpData)
...
if isfield(params,'experiment') && strcmp(params.experiment,'CheckerboardReversals')
    evstart = 2;
else evstart = 1;
end

%Get lfp per trial and apply low-pass filter:
for ev = evstart:nEvents
