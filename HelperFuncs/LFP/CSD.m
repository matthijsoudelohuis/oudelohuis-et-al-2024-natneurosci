...
if plotFigure
    if CSDtype == 1; % plots the voltages for the standard CSD method
        ...
        csdfig = figure; % plots voltage data for the 2nd to 2nd last electrode
        subplot(1,3,1);
        ...
        figure(csdfig) % plots the voltage data for all electrodes
        subplot(1,3,1);
        for j = 1:size(data,2);
...
if plotFigure
    if CSDtype == 1; % plots the CSD for the standard CSD method
        ...
        figure(csdfig) % plots the CSD data for the 2nd to 2nd last electrode
        subplot(1,3,2);
        ...
        figure(csdfig) % plots the CSD data for all electrodes
        subplot(1,3,2);
        for j = 1:size(CSD,2);
